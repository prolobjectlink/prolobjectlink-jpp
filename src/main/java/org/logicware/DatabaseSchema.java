...
public interface DatabaseSchema {
	...
	public DatabaseSchema removeUser(String name);
	...
	public DatabaseSchema removeSequence(String name);
	...
	public DatabaseSchema removeFunctions(String name);
	...
	public DatabaseSchema removeClass(String className);
	...
	public DatabaseSchema addPackage(String packageName);

	public DatabaseSchema addPackage(Package pack);
