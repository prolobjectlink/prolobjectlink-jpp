...
public interface PrologEngine extends Platform, Iterable<PrologClause> {
	 ...
	 * 
	 * engine.asserta(new PrologStructure(grandparent, x, z), new PrologStructure(parent, x, y),
	 * 		new PrologStructure(parent, y, z));
	 * engine.asserta(new PrologStructure(parent, pat, jim));
	 * engine.asserta(new PrologStructure(parent, bob, pat));
	 * engine.asserta(new PrologStructure(parent, bob, ann));
	 * engine.asserta(new PrologStructure(parent, tom, liz));
	 * engine.asserta(new PrologStructure(parent, tom, bob));
	 * engine.asserta(new PrologStructure(parent, pam, bob));
	 * </pre>
	 * 
	 * @param head
	 *            head of rule
	 ...
	 * PrologVariable y = provider.newPrologVariable(&quot;Y&quot;);
	 * PrologVariable z = provider.newPrologVariable(&quot;Z&quot;);
	 * engine.assertz(new PrologStructure(parent, pam, bob));
	 * engine.assertz(new PrologStructure(parent, tom, bob));
	 * engine.assertz(new PrologStructure(parent, tom, liz));
	 * engine.assertz(new PrologStructure(parent, bob, ann));
	 * engine.assertz(new PrologStructure(parent, bob, pat));
	 * engine.assertz(new PrologStructure(parent, pat, jim));
	 * engine.assertz(new PrologStructure(grandparent, x, z), new PrologStructure(parent, x, y),
	 * 		new PrologStructure(parent, y, z));
	 * </pre>
	 * 
	 * @param head
	 ...
	 * PrologAtom pam = provider.newPrologAtom(&quot;pam&quot;);
	 * PrologAtom bob = provider.newPrologAtom(&quot;bob&quot;);
	 * boolean b = engine.clause(new PrologStructure(parent, pam, bob));
	 * </pre>
	 * 
	 * <pre>
	 * String grandparent = &quot;grandparent&quot;;
	 ...
	 * PrologVariable y = provider.newPrologVariable(&quot;Y&quot;);
	 * PrologVariable z = provider.newPrologVariable(&quot;Z&quot;);
	 * boolean b = engine.clause(new PrologStructure(grandparent, x, z), new PrologStructure(parent, x, y),
	 * 		new PrologStructure(parent, y, z));
	 * </pre>
	 * 
	 * @param head
	 ...
	 * PrologVariable y = provider.newPrologVariable(&quot;Y&quot;);
	 * PrologVariable z = provider.newPrologVariable(&quot;Z&quot;);
	 * engine.retract(new PrologStructure(parent, pam, bob));
	 * engine.retract(new PrologStructure(parent, tom, bob));
	 * engine.retract(new PrologStructure(parent, tom, liz));
	 * engine.retract(new PrologStructure(parent, bob, ann));
	 * engine.retract(new PrologStructure(parent, bob, pat));
	 * engine.retract(new PrologStructure(parent, pat, jim));
	 * engine.retract(new PrologStructure(grandparent, x, z), new PrologStructure(parent, x, y),
	 * 		new PrologStructure(parent, y, z));
	 * </pre>
	 * 
	 * @param head
