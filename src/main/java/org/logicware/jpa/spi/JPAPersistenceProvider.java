...
import org.logicware.jpa.JPAAttributeNode;
import org.logicware.jpa.JPAColumnResult;
import org.logicware.jpa.JPAConstructorResult;
import org.logicware.jpa.JPAEntityGraph;
import org.logicware.jpa.JPAEntityManagerFactory;
import org.logicware.jpa.JPAEntityResult;
import org.logicware.jpa.JPAFieldResult;
import org.logicware.jpa.JPANativeQuery;
import org.logicware.jpa.JPAParameter;
import org.logicware.jpa.JPAProperties;
import org.logicware.jpa.JPAProviderUtil;
import org.logicware.jpa.JPAQuery;
import org.logicware.jpa.JPAResultSetMapping;
import org.logicware.jpa.JPAStoredProcedureQuery;
...
public abstract class JPAPersistenceProvider implements PersistenceProvider {
	...
	public EntityManagerFactory createContainerEntityManagerFactory(PersistenceUnitInfo info, Map map) {
		...
		Class<?> objectDriverClass = objectReflector.classForName(driver);
		...
		for (String className : managedClasNames) {
			try {
				Class<?> clazz = objectReflector.classForName(className);
				...
				throw new EntityNotFoundException("The entity class '" + className + "' not found in the classpath");
			}
		}
