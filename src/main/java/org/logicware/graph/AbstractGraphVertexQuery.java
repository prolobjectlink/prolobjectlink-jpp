...
public abstract class AbstractGraphVertexQuery<V> implements GraphVertexQuery<V> {

	protected final GraphVertex<V> vertex;

	public AbstractGraphVertexQuery(GraphVertex<V> vertex) {
		this.vertex = vertex;
	}
