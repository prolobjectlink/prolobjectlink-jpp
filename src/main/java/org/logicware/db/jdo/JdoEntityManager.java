...
public final class JdoEntityManager extends JdoPersistenceManager implements EntityManager {

	public JdoEntityManager(DatabaseEngine database, EntityManagerFactory managerFactory,
