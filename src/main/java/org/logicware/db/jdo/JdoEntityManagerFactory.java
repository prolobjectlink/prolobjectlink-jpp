...
public class JdoEntityManagerFactory extends JdoPersistenceManagerFactory implements EntityManagerFactory {

	private static final long serialVersionUID = -264462258140277668L;
	...
	public JdoEntityManagerFactory(DatabaseEngine database) {
	...
	public EntityManager createEntityManager(SynchronizationType synchronizationType, Map map) {
		return new JdoEntityManager(database, this, synchronizationType, properties, entityMap, namedQueries,
