...
public final class EmbeddedRelationalDB extends AbstractDatabaseService implements EmbeddedDatabase {

	private static EmbeddedRelationalDB embeddedRelationalDB;

	private EmbeddedRelationalDB(PrologProvider provider, Settings properties, ObjectConverter<PrologTerm> converter,
	...
	public static final EmbeddedDatabase newInstance() {
