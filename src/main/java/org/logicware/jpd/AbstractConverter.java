...
public abstract class AbstractConverter<T> extends ObjectReflector implements ObjectConverter<T> {
    ...
    //
    public abstract Class<?> toClass(T prologTerm);

    public abstract Object toObject(T prologTerm);
    ...
    //
    public abstract T toTerm(Object object);

    public abstract T[] toTermsArray(Object[] objects);
    ...
    public abstract T toTerm(Object object, Map<String, T> solutionsMap);
