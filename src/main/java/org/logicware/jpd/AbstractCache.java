...
public abstract class AbstractCache extends AbstractVolatileContainer implements VolatileContainer {

    public AbstractCache(PrologProvider provider, Properties properties, ObjectConverter<PrologTerm> converter) {
	...
	ArrayList<Class<?>> classes = classesOf(prologTerms);
	...
	if (query.hasSolution()) {
		...
		// return (O) factory.createObject(goal);
		return o;
	    }
	}
