...
public class JpaWhere<T> extends JpaAbstractQuery<T> implements AbstractQuery<T> {

	public JpaWhere(Expression<Boolean> restriction, Metamodel metamodel, Class<T> resultType) {
		super(restriction, metamodel, resultType);
	}

	public JpaWhere(Predicate[] restrictions, Metamodel metamodel, Class<T> resultType) {
